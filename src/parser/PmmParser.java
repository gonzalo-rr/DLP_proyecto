...
public class PmmParser extends Parser {
	...
	public final MainContext main() throws RecognitionException {
		...
		try {
			...
			match(T__5);
			setState(74);
			((MainContext)_localctx).var_definitions = var_definitions();
			setState(75);
			((MainContext)_localctx).statements = statements();
			setState(76);
			match(T__6);
			 ((MainContext)_localctx).ast =  new FuncDefinition((((MainContext)_localctx).NAME!=null?((MainContext)_localctx).NAME.getText():null), VoidType.getInstance(), ((MainContext)_localctx).var_definitions.ast, ((MainContext)_localctx).statements.ast, ((MainContext)_localctx).OP.getLine(), ((MainContext)_localctx).OP.getCharPositionInLine() + 1); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Func_definitionContext func_definition() throws RecognitionException {
		...
		try {
			...
			match(T__5);
			setState(112);
			((Func_definitionContext)_localctx).var_definitions = var_definitions();
			setState(113);
			((Func_definitionContext)_localctx).statements = statements();
			setState(114);
			match(T__6);
			 ((Func_definitionContext)_localctx).ast =  new FuncDefinition((((Func_definitionContext)_localctx).ID!=null?((Func_definitionContext)_localctx).ID.getText():null), _localctx.t, ((Func_definitionContext)_localctx).var_definitions.ast, ((Func_definitionContext)_localctx).statements.ast, ((Func_definitionContext)_localctx).OP.getLine(), ((Func_definitionContext)_localctx).OP.getCharPositionInLine() + 1); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
